...
{
    int32 data_int = 0;                                                           // 整数部分
    int32 data_float = 0.0;                                                       // 小数部分
    int32 data_temp[8];                                                           // 整数字符缓冲
    int32 data_temp_point[6];                                                     // 小数字符缓冲
...
void func_double_to_str (char *str, double number, uint8 point_bit)
{
    int32 data_int = 0;                                                           // 整数部分
    int32 data_float = 0.0;                                                       // 小数部分
    int32 data_temp[12];                                                          // 整数字符缓冲
    int32 data_temp_point[9];                                                     // 小数字符缓冲
    uint8 temp_bit = point_bit;                                                      // 转换精度位数
	...
	do
    {
        ...
        // 提取整数部分
        data_int = (int32)number;                                                 // 直接强制转换为 int
        if(0 > number)                                                          // 判断源数据是正数还是负数
        {
            *str ++ = '-';
        }
        ...
        data_float = (int32)number;                                               // 获取这部分数值
