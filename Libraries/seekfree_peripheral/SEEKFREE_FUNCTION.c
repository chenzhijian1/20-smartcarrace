...
//            data_temp[dat_bit ++] = func_abs(number_temp);                          // 倒序将数值提取出来
//            number /= 10;                                                       // 削减被提取的个位数
//        }
//        while(0 != dat_bit)                                                         // 提取的数字个数递减处理
//        {
//            *str ++ = (data_temp[dat_bit - 1] + 0x30);                              // 将数字从倒序数组中倒序取出 变成正序放入字符串
//            dat_bit --;
//        }
//    }while(0);
//}
...
//        while(0 != number)                                                      // 循环直到数值归零
//        {
//            data_temp[dat_bit ++] = (number % 10);                                  // 倒序将数值提取出来
//            number /= 10;                                                       // 削减被提取的个位数
//        }
//        while(0 != dat_bit)                                                         // 提取的数字个数递减处理
//        {
...
//    uint8 dat_bit = point_bit;                                                      // 转换精度位数
...
//        do
//        {
//            data_temp[dat_bit ++] = data_int % 10;                                  // 将整数部分倒序写入字符缓冲区
//            data_int /= 10;
//        }while(0 != data_int);
//        while(0 != dat_bit)
//        {
//            *str ++ = (func_abs(data_temp[dat_bit - 1]) + 0x30);                    // 再倒序将倒序的数值写入字符串 得到正序数值
//            dat_bit --;
//        }
...
//                {
//                    data_temp_point[dat_bit ++] = data_float % 10;                  // 倒序写入字符缓冲区
//                    data_float /= 10;
//                    point_bit --;                                                
//                }
//                while(0 != dat_bit)
//                {
//                    *str ++ = (func_abs(data_temp_point[dat_bit - 1]) + 0x30);      // 再倒序将倒序的数值写入字符串 得到正序数值
//                    dat_bit --;
//                }
//            }
//        }
...
//        while(0 != number)                                                      // 循环直到数值归零
//        {
//            data_temp[dat_bit ++] = (number & 0xF);                                 // 倒序将数值提取出来
//            number >>= 4;                                                       // 削减被提取的个位数
//        }
//        while(0 != dat_bit)                                                         // 提取的数字个数递减处理
//        {
//            *str ++ = hex_index[data_temp[dat_bit - 1]];                            // 将数字从倒序数组中倒序取出 变成正序放入字符串
//            dat_bit --;
//        }
//    }while(0);
//}
